...
<head>
    ...
    <link rel="stylesheet" href="/frontdetails/css/style.css">
...
<body>
    ...
    <header>
        ...
        <!-- <div class="container">
            <div class="img">
                @if ($products->image != "")
                <img width="300" src="{{ asset('uploads/products/'.$products->image) }}" alt="">
                @endif
            </div>
            <div class="description">
                ...
                <p>{!! clean($products->description) !!}</p> -->
                <!-- <p>{!! $products->description !!}</p> -->
                <!-- <h1>{{$products->name}}</h1> -->
            </div>
        <!-- </div> --> 
        ...
        <div class="container flex">
            <div class="left">
                <div class="main_image">
                    <!-- <img src="/frontdetails/image/p1.jpg" class="slide"> -->
                    @if ($products->image != "")
                    <img width="300" src="{{ asset('uploads/products/'.$products->image) }}" alt="">
                    @endif
                </div>
                <!-- <div class="option flex">
                    <img src="/frontdetails/image/p1.jpg" onclick="img('image/p1.jpg')">
                    <img src="/frontdetails/image/p2.jpg" onclick="img('image/p2.jpg')">
                    <img src="/frontdetails/image/p3.jpg" onclick="img('image/p3.jpg')">
                    <img src="/frontdetails/image/p4.jpg" onclick="img('image/p4.jpg')">
                    <img src="/frontdetails/image/p5.jpg" onclick="img('image/p5.jpg')">
                    <img src="/frontdetails/image/p6.jpg" onclick="img('image/p6.jpg')">
                </div> -->
            </div>
            <div class="right">
                <h3>{{$products->name}}</h3>
