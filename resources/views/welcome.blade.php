...
<body>
  ...
  <header>
    ...
    <!-- <section class="py-3" style="background-image: url('frontend/images/background-pattern.jpg');background-repeat: no-repeat;background-size: cover;">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="banner-blocks">
              ...
              <div class="banner-ad bg-success-subtle block-2" style="background:url('frontend/images/ad-image-1.png') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">
              ...
              <div class="banner-ad bg-danger block-3" style="background:url('frontend/images/ad-image-2.png') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="frontend/images/product-thumb-11.jpg" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="frontend/images/product-thumb-12.jpg" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Amber Jar</p>
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="frontend/images/product-thumb-13.jpg" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Amber Jar</p>
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="frontend/images/product-thumb-14.jpg" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Amber Jar</p>
                ...
                <div class="tab-pane fade show active" id="nav-all" role="tabpanel" aria-labelledby="nav-all-tab">
                  ...
                  <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                      ...
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="index.html" title="Product Title">
                            <img src="frontend/images/thumb-biscuits.png"  class="tab-image">
                          </a>
                        </figure>
                    ...
                    <div class="col">
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="index.html" title="Product Title">
                            <img src="frontend/images/thumb-bananas.png"  class="tab-image">
                          </a>
                        </figure>
                        <h3>Sunstar Fresh Melon Juice</h3>
                        <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                  ...
                  <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                    ...
                    <div class="col">
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="index.html" title="Product Title">
                            <img src="frontend/images/thumb-orange-juice.png"  class="tab-image">
                          </a>
                        </figure>
                        <h3>Sunstar Fresh Melon Juice</h3>
                        <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                    ...
                    <div class="col">
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="index.html" title="Product Title">
                            <img src="frontend/images/thumb-raspberries.png"  class="tab-image">
                          </a>
                        </figure>
                        <h3>Sunstar Fresh Melon Juice</h3>
                        <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                  ...
                  <div class="col">
                    <div class="product-item">
                      ...
                      <figure>
                        <a href="index.html" title="Product Title">
                          <img src="frontend/images/thumb-tomatoketchup.png" class="tab-image">
                        </a>
                      </figure>
                      <h3>Sunstar Fresh Melon Juice</h3>
                      <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary">
    ...
    <!-- <section class="py-5">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="banner-ad bg-danger mb-3" style="background: url('frontend/images/ad-image-3.png');background-repeat: no-repeat;background-position: right bottom;">
          ...
          <div class="col-md-6">
            <div class="banner-ad bg-info" style="background: url('frontend/images/ad-image-4.png');background-repeat: no-repeat;background-position: right bottom;">
              <div class="banner-content p-5">
        ...
        <div class="row">
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="frontend/images/post-thumb-1.jpg" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="frontend/images/post-thumb-2.jpg" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="frontend/images/post-thumb-3.jpg" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
    ...
    <section class="py-5 my-5">
      <div class="container-fluid">
        ...
        <div class="bg-warning py-5 rounded-5" style="background-image: url('frontend/images/bg-pattern-2.png') no-repeat;">
          <div class="container">
            <div class="row">
              <div class="col-md-4">
                <img src="frontend/images/phone.png" alt="phone" class="image-float img-fluid">
              </div>
              <div class="col-md-8">
                ...
                <div class="d-flex gap-2 flex-wrap">
                  <img src="frontend/images/app-store.jpg" alt="app-store">
                  <img src="frontend/images/google-play.jpg" alt="google-play">
                </div>
              </div>
            </div>
          </div>
